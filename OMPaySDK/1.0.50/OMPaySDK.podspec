...
f.dependency 'FooYeepalAuthenticationUI', '2.0.25-ompay'
...
f.dependency 'FooYeepalCardManagementUI', '2.0.25-ompay'
...
f.dependency 'FooYeepalCoreUI', '2.0.33.21-ompay'
f.dependency 'FooRequesterWrapper', '1.0.29.6-ompay'
...
f.dependency 'YeepalProductServicesInterfacesExtension', '1.0.6'
f.dependency 'YeepalAppleWalletExtensionService', '1.0.3'
f.dependency 'YeepalProductServicesInterfaces'
f.dependency 'YeepalAppleWalletService'
f.dependency 'YeepalAppleWalletUI'
