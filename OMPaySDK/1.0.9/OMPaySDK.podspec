...
f.dependency 'FooYeepalCardManagementUI', '2.0.20-ompay'
f.dependency 'FooMbProgressHud'
f.dependency 'FooSdWebImage'
f.dependency 'FooYeepalP2PUI', '2.0.21-ompay'
f.dependency 'FooYeepalAddMoneyUI', '2.0.12-ompay'
f.dependency 'FooYeepalScanToPay', '2.0.10-ompay'
f.dependency 'FooYeepalR2PUI', '1.0.12-ompay'

f.dependency 'FooYeepalCoreUI', '2.0.33.6-ompay'
...
f.dependency 'FooYeepalAliasBeneficiariesUI', '1.0.4-ompay'
f.dependency 'FooCardControl', '2.0.0.2-ompay'
f.dependency 'FooAddress', '2.0.1-ompay'
...
f.dependency 'FooRemittanceUI', '0.0.82-ompay'
f.dependency 'FooVCN', '2.0.0-ompay'
