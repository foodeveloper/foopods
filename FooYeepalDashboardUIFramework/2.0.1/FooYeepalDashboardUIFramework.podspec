Pod::Spec.new do |s|
    s.name = "FooYeepalDashboardUIFramework"
    s.version = "2.0.1"
    s.summary = "Foo Yeepal Dashboard UI"
    ...
    s.source = { :git => "git@github.com:foodeveloper/foo-yeepal-2.0-dashboard-ui.git", :tag => "#{s.version}"}
    ...
    s.subspec 'Framework' do |d|
        d.vendored_frameworks = 'xcframework/FooYeepalDashboardUI.xcframework'
