Pod::Spec.new do |s|
    s.name = "YeepalAppleWalletUIFramework"
    s.version = "1.0.2"
    ...
    s.static_framework = true
     ...
     s.subspec 'Framework' do |f|
        f.vendored_frameworks = 'YeepalAppleWalletUI/YeepalAppleWalletUI.xcframework'
        f.dependency "FooYeepalCoreUIFramework"
        f.dependency "YeepalAppleWalletServiceFramework"
    end
end
